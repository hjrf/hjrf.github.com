window.skins={};
...
})(eui.Skin);generateEUI.paths['resource/custom_skins/workitem.exml'] = window.herosListIn = (function (_super) {
	__extends(herosListIn, _super);
	function herosListIn() {
		_super.call(this);
		this.skinParts = [];
	...
	var _proto = herosListIn.prototype;
